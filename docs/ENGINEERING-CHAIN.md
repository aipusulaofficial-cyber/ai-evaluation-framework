...
|---|---|---|
| Architecture | [ARCHITECTURE.md](../ARCHITECTURE.md) | Versioned suites, judge/model adapters, rubrics and adjudication and system boundaries |
| ADR | [0002-production-hardening.md](../ADRs/0002-production-hardening.md) | Explicit design trade-offs and production boundaries |
| Contracts | [tests/test_eval.py](../tests/test_eval.py) | Contract-focused validation at the repository boundary |
