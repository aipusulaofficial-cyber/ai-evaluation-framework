...
Define evaluation suites as versioned contracts; isolate judge/model adapters; record dataset, rubric, scorer, and run metadata; require reproducible results and explicit adjudication for disagreements.
